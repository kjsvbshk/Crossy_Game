...
const limbGeometry = new THREE.CylinderGeometry(ARM.radiusTop, ARM.radiusBottom, limbLen, 6);
limbGeometry.rotateX(Math.PI / 2);

const elbowGeometry = new THREE.CylinderGeometry(ARM.radiusBottom, ARM.radiusBottom, ARM_OFFSET_X + 4, 6);
elbowGeometry.rotateZ(Math.PI / 2); // this one stays horizontal, along X

const capGeometry = new THREE.SphereGeometry(TRUNK.radiusTop, 6, 4);
const armCapGeometry = new THREE.SphereGeometry(ARM.radiusTop, 6, 4);
