...
const discGeometry = new THREE.CylinderGeometry(RADIUS, RADIUS, THICKNESS, 8);
const rimGeometry = new THREE.CylinderGeometry(RADIUS * 1.12, RADIUS * 1.12, THICKNESS * 0.55, 8);
// A little self-glow so coins read as "grab me" against the ground.
const discMaterial = flatMaterial({ color: COLORS.COIN, roughness: 0.35, emissive: 0x6b4e10, emissiveIntensity: 0.6 });
const rimMaterial = flatMaterial({ color: COLORS.COIN_RIM, roughness: 0.4 });
